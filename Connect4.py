...
#a tkinter GUI that plays connect four
#Source:
import random
...
def display_board(board):
    """This function accepts the Connect 4 board as a parameter.  
   It will print the Connect 4 board grid (using ASCII characters)
...
def make_user_move(board):
    """This function accepts the Connect 4 board as a parameter.  
   It will ask the user for a row and column.  If the row is 1 to 6 and
   column are within the range 1 to 7, and that square
...
def make_computer_move(board):
    """This function accepts the Connect 4 board as a parameter.  
   It will randomly pick row from 1 to 6 and column from 1 to 7.  
